<!doctag html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="https://cdn-icons-png.freepik.com/512/7412/7412637.png" tag="image/x-icon">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.events.index' ? 'bg-secondary' : '' }}"
                                        ...
                                        <i class="fa-regular fa-calendar fa-lg fa-fw"></i> Events List
                                    </a>
                                </li>
